-- Create a secure function for quiz submission that bypasses RLS
-- Date: 2025-01-08
-- Purpose: Allow verified users to submit quiz responses through a controlled function

-- Create function to submit quiz responses and mark quiz as completed
...
DO $$
BEGIN
    RAISE NOTICE '✅ Quiz submission function created successfully';
    RAISE NOTICE '🔒 Function uses SECURITY DEFINER to bypass RLS';
    RAISE NOTICE '✅ Ready for client-side quiz submissions';
END $$;