...
const Logo: React.FC<LogoProps> = ({ 
  ...
  if (variant === 'icon') {
    return (
      <div className={`${sizeClasses[size]} rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 p-2 shadow-lg flex items-center justify-center ${className}`}>
        <svg 
          viewBox="0 0 24 24" 
          fill="none" 
  ...
  return (
    <div className={`flex items-center space-x-3 ${className}`}>
      <div className={`${sizeClasses[size]} rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 p-2 shadow-lg flex items-center justify-center`}>
        <svg 
          viewBox="0 0 24 24" 
          fill="none" 
          className="w-full h-full text-white"
      ...
      <div className="flex flex-col">
        <span className={`font-sacramento ${textSizes[size]} text-white leading-tight text-shadow-custom`}>
          Purrfect Stays
        </span>
      </div>
    </div>
